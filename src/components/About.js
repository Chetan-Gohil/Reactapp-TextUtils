          ...
          <div className="accordion-item" style={myStyle}>
            ...
            >
              <div className="accordion-body">
                This is the Best TextUtilssssss Application.Textutils gives you a way to analyze your text quickly and efficiently . Be it word count ,character count  and Preview also...Analyzing your text allows for deeper insights and understanding. It's a process of unraveling layers of meaning, uncovering nuances, and discovering connections. Embrace the journey of analysis; it opens doors to knowledge and enhances comprehension......
              </div>
            </div>
          </div>
          <div className="accordion-item" style={myStyle}>
